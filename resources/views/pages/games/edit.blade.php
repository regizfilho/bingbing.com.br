...
new class extends Component {
    ...
    public function mount(string $uuid): void
    {
        ...
        $this->show_drawn_to_players = $this->game->show_drawn_to_players ?? true;
        $this->show_player_matches = $this->game->show_player_matches ?? true;
        $this->auto_claim_prizes = $this->game->auto_claim_prizes ?? true;
        ...
        try {
            DB::transaction(function () {
                $this->game->update([
                    ...
                    'auto_draw_seconds' => $this->auto_draw_seconds ?? 3,
        ...
        <div class="space-y-10">
            ...
            <form wire:submit.prevent="update" class="space-y-10">
                        ...
                        <div class="flex justify-between items-start mb-8">
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-[8px] text-blue-500 font-bold mt-2">💡 Dica: Preencha todos os títulos antes de salvar</p>
                                </div>
                            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-10">
                    ...
                    <a href="{{ route('games.index') }}" class="w-full text-center py-8 border border-white/10 rounded-[2.5rem] font-black uppercase text-[10px] tracking-widest text-slate-600 hover:text-white hover:bg-white/5 transition-all italic">CANCELAR EDIÇÃO</a>
                </div>
            </form>
        </div>
    </div>
