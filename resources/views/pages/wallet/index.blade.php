...
new #[Layout('layouts.app')] class extends Component {
    ...
    public function applyCoupon(): void
    {
        ...
        $this->discountAmount = $coupon->type === 'percent' ? ($this->selectedPackage->price_brl * $coupon->value) / 100 : $coupon->value;
    ...
    <div class="max-w-6xl mx-auto px-6 pt-16">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
            <div class="space-y-2">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-[10px] font-black text-blue-500 uppercase tracking-[0.5em] italic">Gerenciamento
                        de Créditos</span>
                </div>
                ...
                <div class="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div class="space-y-6">
                        <div
                            ...
                            <span class="text-[9px] font-black text-blue-400 uppercase tracking-widest italic">Saldo
                        ...
                        <div class="w-full h-2 bg-white/5 rounded-full overflow-hidden shadow-inner">
                            <div
                                class="h-full bg-gradient-to-r from-blue-600 to-cyan-400 w-full shadow-[0_0_15px_rgba(37,99,235,0.3)]">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span
                                    class="text-[10px] font-black text-white uppercase italic tracking-widest leading-none">Protegida</span>
                            </div>
                        </div>
                        <div
                            class="bg-white/[0.03] border border-white/5 p-6 rounded-[2.5rem] backdrop-blur-sm shadow-xl">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span
                                    class="text-[10px] font-black text-white uppercase italic tracking-widest leading-none">Imediato</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mb-16">
            <div class="flex items-center gap-4 mb-12 px-2">
                ...
                <h2 class="text-sm font-black text-white uppercase tracking-[0.3em] italic">Escolha o seu Pacote de
                    Recarga</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                @forelse ($this->packages as $package)
                    <div wire:click="selectPackage({{ $package->id }})"
                        ...
                        <div class="relative z-10 flex flex-col items-center">
                            ...
                            <span
                                class="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] mb-2 italic group-hover:text-blue-500 transition-colors">{{ $package->name }}</span>
                            ...
                            <div class="w-full pt-10 border-t border-white/5 flex flex-col items-center">
                                <div class="flex items-start gap-1 mb-8">
                                    ...
                                    <span
                                        class="text-4xl font-black text-white italic tracking-tighter">{{ number_format($package->price_brl, 2, ',', '.') }}</span>
                                </div>
                ...
                @empty
                    <div
                        ...
                        <p class="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">Nenhum pacote
            ...
            <a href="{{ route('wallet.transactions') }}"
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-[9px] font-bold text-slate-600 uppercase tracking-widest mt-2">Veja todo o seu
                            histórico</p>
                    </div>
                </div>
            ...
            <a href="{{ route('dashboard') }}"
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-[9px] font-bold text-slate-600 uppercase tracking-widest mt-2">Voltar para o
                            centro de comando</p>
                    </div>
                </div>
                <div class="text-slate-700 group-hover:text-blue-500 transition-colors">
                ...
                <div class="p-12 sm:p-16">
                    ...
                    <div class="bg-white/[0.02] border border-white/5 rounded-[3rem] p-8 mb-10 space-y-6 shadow-inner">
                        <div class="flex justify-between items-center border-b border-white/5 pb-6">
                            ...
                            <span
                                class="text-xs font-black text-white uppercase italic tracking-widest">{{ $this->selectedPackage->name }}</span>
                        </div>
                        <div class="flex justify-between items-center border-b border-white/5 pb-6">
                            <span
                                class="text-[9px] font-black text-slate-500 uppercase tracking-widest italic">Créditos</span>
                            <span
                                class="text-3xl font-black text-blue-500 italic">+{{ number_format($this->selectedPackage->credits, 0, ',', '.') }}</span>
                        </div>
                        <div class="flex justify-between items-center pt-2">
                            <span class="text-[9px] font-black text-blue-400 uppercase tracking-widest italic">Total a
                                Pagar</span>
                            <span class="text-4xl font-black text-white italic tracking-tighter">R$
                                {{ number_format($this->selectedPackage->price_brl, 2, ',', '.') }}</span>
                        </div>
                    </div>

                    {{-- Cupom --}}
                    <div class="mt-6 space-y-4">
                        <input type="text" wire:model.defer="couponCode" placeholder="Digite seu cupom"
