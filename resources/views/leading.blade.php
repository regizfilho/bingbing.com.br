...
<head>
    ...
    <meta name="description" content="Plataforma moderna de bingo social. Crie salas personalizadas, convide amigos, sorteie números em tempo real e concorra a prêmios. Junte-se à maior comunidade de bingo do Brasil.">
    <meta name="keywords" content="bingo online, bingo social, jogar bingo, criar sala de bingo, bingo com amigos, sorteios ao vivo">
    ...
    <meta property="og:description" content="Crie sua sala, jogue com amigos e ganhe prêmios em tempo real. O novo jeito de jogar bingo.">
    ...
    <style>
        ...
        @media (prefers-reduced-motion) {
            .animate-float, .stats-card:hover { animation: none; transition: none; }
        }
    </style>
</head>
<body class="antialiased">
    ...
    <nav class="fixed top-0 w-full z-[100] bg-[#020408]/80 backdrop-blur-xl border-b border-white/5">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl flex items-center justify-center shadow-lg shadow-blue-600/20">
            ...
            <div class="flex items-center gap-4">
                @auth
                    <a href="{{ url('/dashboard') }}" class="bg-blue-600 hover:bg-blue-500 px-6 py-2.5 rounded-xl text-sm font-medium text-white transition-all shadow-lg shadow-blue-600/20">
                        Dashboard
                    </a>
                @else
    ...
    <main class="relative pt-36 pb-20 px-6">
        <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="space-y-8">
                <div class="inline-flex items-center gap-2 bg-blue-500/10 px-4 py-2 rounded-full border border-blue-500/20">
                ...
                <div class="grid grid-cols-3 gap-8 pt-8 border-t border-white/5">
                    <div>
                        ...
                        <div class="text-xs text-slate-600 font-medium uppercase tracking-wider mt-1">Salas criadas</div>
                    </div>
                    <div>
                ...
                <div class="relative glass p-8 rounded-[2.5rem] border border-white/5">
                    ...
                    <div class="grid grid-cols-5 gap-2 mb-6">
                        @foreach([7, 22, 45, 61, 74, 12, 19, 33, 58, 69, 5, 27, 40, 52, 63, 15, 30, 44, 55, 71, 2, 25, 38, 49, 66] as $i => $n)
                            <div class="aspect-square rounded-lg flex items-center justify-center font-medium {{ $i % 3 == 0 ? 'bg-blue-600 text-white' : 'bg-white/5 text-slate-500 border border-white/5' }}">
                                {{ $n }}
                            </div>
                        @endforeach
                    </div>
    ...
    <section id="como-funciona" class="py-24 relative border-t border-white/5">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center max-w-2xl mx-auto mb-16">
                <span class="text-sm font-medium text-blue-500 uppercase tracking-wider mb-3 block">Simples e rápido</span>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center p-8">
                    ...
                    <p class="text-slate-500">Defina um nome, escolha a quantidade de cartelas e convide seus amigos com um código único.</p>
                </div>
                ...
                <div class="text-center p-8">
                    ...
                    <p class="text-slate-500">Os números são sorteados em tempo real. Clique na cartela para marcar e completar sua sequência.</p>
                </div>
                ...
                <div class="text-center p-8">
                    ...
                    <p class="text-slate-500">Faça bingo, conquiste prêmios e suba no ranking. Quanto mais joga, mais recompensas.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="recursos" class="py-24 bg-white/5">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div>
                    <span class="text-sm font-medium text-blue-500 uppercase tracking-wider mb-3 block">Por que BingBing?</span>
                    <h2 class="font-heading text-4xl md:text-5xl font-bold text-white tracking-tight mb-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-4">
                            <div class="w-6 h-6 bg-blue-600/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
                                <span class="text-blue-500 text-sm">✓</span>
                            </div>
                            <div>
                                <h4 class="font-bold text-white">Salas privadas</h4>
                                <p class="text-slate-500 text-sm">Crie salas com código de acesso e jogue apenas com quem você convidar.</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-4">
                            <div class="w-6 h-6 bg-blue-600/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
                            ...
                            <div>
                                ...
                                <p class="text-slate-500 text-sm">Você define os prêmios de cada rodada. Pode ser crédito, reconhecimento ou nada.</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-4">
                            <div class="w-6 h-6 bg-blue-600/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
                            ...
                            <div>
                                ...
                                <p class="text-slate-500 text-sm">Histórico de todas as partidas, vitórias e hall da fama.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="glass p-8 rounded-2xl border border-white/5">
                    ...
                    <p class="text-slate-300 mb-6">"Uso toda semana com meus amigos. Ficamos horas jogando e a experiência é muito fluida, parece um jogo profissional."</p>
                ...
                <div class="glass p-8 rounded-2xl border border-white/5">
                    ...
                    <p class="text-slate-300 mb-6">"Organizo torneios no meu clube e o BingBing foi a ferramenta perfeita. Todos conseguem jogar pelo celular sem complicação."</p>
                ...
                <div class="glass p-8 rounded-2xl border border-white/5">
                    ...
                    <p class="text-slate-300 mb-6">"Simplesmente viciante. O sistema de ranking me faz querer jogar cada vez mais para subir de posição."</p>
